...
- **[player](./player)**
  ...
  - [*:: play_animation_action() [ Проиграть анимацию игроку ]*](./player.md#player_play_animation_action)
...
- **[variable](./variable)**
  ...
  - [*:: get_sound_volume_action() [ Получить громкость звука ]*](./variable.md#set_variable_get_sound_volume_action)
  ...
  - [*:: set_sound_volume_action() [ Установить громкость звука ]*](./variable.md#set_variable_set_sound_volume_action)
...
- **[entity](./entity)**
  ...
  - [*:: celar_potion_effects() [ Очистить эффекты ]*](./entity.md#entity_celar_potion_effects)
  ...
  - [*:: set_creeper_explosion_power() [ Установить криперу силу взрыва ]*](./entity.md#entity_set_creeper_explosion_power)
