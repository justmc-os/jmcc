...
**Пример использования:**
```ts
var a = variable::perlin_noise_3d(0, location(0, 0, 0), 0, 0, 0, "TRUE")

// или от переменной:

var b = location(0, 0, 0)
var c = b.perlin_noise_3d(0, 0, 0, 0, "TRUE")
```
...
**Пример использования:**
```ts
var a = variable::simplex_noise_3d(0, location(0, 0, 0))

// или от переменной:

var b = location(0, 0, 0)
var c = b.simplex_noise_3d(0)
```
...
**Пример использования:**
```ts
var a = variable::voronoi_noise_3d(location(0, 0, 0), 0, 0)

// или от переменной:

var b = location(0, 0, 0)
var c = b.voronoi_noise_3d(0, 0)
```
