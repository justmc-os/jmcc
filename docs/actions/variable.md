...
**Пример использования:**
```ts
var a = variable::append_list(переменная, переменная)

// или от переменной:

var b = переменная
var c = b.append_list(переменная)
```
...
**Пример использования:**
```ts
variable::append_value(переменная, ["любое значение", "любое значение"])

// или от переменной:

var a = переменная
a.append_value(["любое значение", "любое значение"])
```
...
**Пример использования:**
```ts
variable::add_item_enchantment(переменная, item("stone"), "текст", 0)
```
...
**Пример использования:**
```ts
variable::get_item_color(переменная, item("stone"))
```
...
**Пример использования:**
```ts
variable::get_item_custom_tags(переменная, item("stone"))
```
...
**Пример использования:**
```ts
variable::get_item_enchantments(переменная, item("stone"))
```
...
**Пример использования:**
```ts
variable::get_item_nbt_tags(переменная, item("stone"))
```
...
**Пример использования:**
```ts
variable::get_player_head(переменная, "текст")
```
...
**Пример использования:**
```ts
variable::remove_enchantment(переменная, item("stone"), "текст")
```
...
**Пример использования:**
```ts
variable::set_item_color(переменная, item("stone"), "текст")
```
...
**Пример использования:**
```ts
variable::set_item_enchantments(переменная, item("stone"), переменная)
```
...
**Пример использования:**
```ts
variable::set_item_visibility_flags(переменная, item("stone"), "ON", "ON", "ON", "ON", "ON", "ON", "ON")
```
...
**Имя:** Получить значение координаты\
**Тип:** Действие, устанавливающее значение\
**Пример использования:**
```ts
...
**Пример использования:**
```ts
var a = variable::location_relative(location(0, 0, 0), 0, "DOWN")

// или от переменной:

var b = location(0, 0, 0)
var c = b.location_relative(0, "DOWN")
```
...
**Пример использования:**
```ts
variable::random_location(переменная, location(0, 0, 0), location(0, 0, 0))
```
...
**Имя:** Установить значение координаты местоположения\
**Тип:** Действие, устанавливающее значение\
**Пример использования:**
```ts
...
**Пример использования:**
```ts
variable::shift_location_in_direction(переменная, location(0, 0, 0), 0, "FORWARD")
```
...
**Пример использования:**
```ts
variable::get_potion_effect_amplifier(переменная, potion("slow_falling"))
```
...
**Пример использования:**
```ts
variable::get_potion_effect_duration(переменная, potion("slow_falling"))
```
...
**Пример использования:**
```ts
variable::get_potion_effect_type(переменная, potion("slow_falling"))
```
...
**Пример использования:**
```ts
variable::get_sound_volume_action(переменная, sound("entity.zombie.hurt"))
```
...
**Пример использования:**
```ts
variable::get_template_code(переменная, item("stone"), "TEXT")
```
...
**Пример использования:**
```ts
variable::set_potion_effect_amplifier(переменная, potion("slow_falling"), 0)
```
...
**Пример использования:**
```ts
variable::set_potion_effect_duration(переменная, potion("slow_falling"), 0)
```
...
**Пример использования:**
```ts
variable::set_potion_effect_type(переменная, potion("slow_falling"), "текст")
```
...
**Пример использования:**
```ts
variable::set_sound_type(переменная, sound("entity.zombie.hurt"), "текст", "текст")
```
...
**Пример использования:**
```ts
variable::set_sound_volume_action(переменная, sound("entity.zombie.hurt"), 0)
```
...
**Пример использования:**
```ts
variable::set_template_code(переменная, item("stone"), "любое значение")
```
...
**Пример использования:**
```ts
variable::convert_text_to_number(переменная, "текст", 0)
```
...
**Пример использования:**
```ts
variable::get_particle_spread(переменная, particle("fire"), "VERTICAL")
```
...
**Пример использования:**
```ts
variable::set_particle_spread(переменная, particle("fire"), 0, 0)
```
...
**Пример использования:**
```ts
variable::get_list_variables(переменная, "GAME")
```
...
| ---------- | ----------------------------------------------------------------------------------------- | ------------ |
| `variable` | переменная                                                                                |              |
| `scope`    | перечисление:<br/>**GAME** - undefined<br/>**SAVE** - undefined<br/>**LOCAL** - undefined |              |
...
**Пример использования:**
```ts
variable::char_to_number(переменная, "текст")
```
...
**Пример использования:**
```ts
variable::clear_color_codes(переменная, "текст")
```
...
**Пример использования:**
```ts
variable::convert_number_to_text(переменная, 0, 0)
```
...
**Пример использования:**
```ts
variable::parse_json(переменная, "текст")
```
...
**Пример использования:**
```ts
variable::strip_text(переменная, "текст", "ALL")
```
...
| `variable`   | переменная                                                                                                         |              |
| `text`       | текст                                                                                                              |              |
| `strip_type` | перечисление:<br/>**ALL** - undefined<br/>**START** - undefined<br/>**END** - undefined<br/>**INDENT** - undefined |              |
...
**Пример использования:**
```ts
variable::to_json(переменная, "любое значение")
```
...
| ---------------- | -------------- | ------------------------- |
| `variable`       | переменная     | Переменная для присвоения |
| `start_location` | местоположение | Начальное местоположение  |
| `end_location`   | местоположение | Конечное местоположение   |
...
**Пример использования:**
```ts
variable::get_light_level(переменная, location(0, 0, 0), "TOTAL")
```
...
**Имя:** Получить результат рейтрейсинга\
**Тип:** Действие без значения\
**Пример использования:**
```ts
variable::ray_trace_result(location(0, 0, 0), 0, 0, "ONLY_BLOCKS", "TRUE", "NEVER", переменная, переменная, переменная, переменная)
```
...
| `variable_for_hit_location`       | переменная                                                                                                                                            | Местоположение падения луча   |
