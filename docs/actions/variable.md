...
**Пример использования:**
```ts
var a = variable::get_list_value(переменная, 0, "TRUE")

// или от переменной:

var b = переменная
var c = b.get_list_value(0, "TRUE")
```
...
| `list`     | переменная                                                      | Список                      |
| `number`   | число                                                           | Индекс                      |
| `remove`   | перечисление:<br/>**TRUE** - Удалять<br/>**FALSE** - Не удалять | Удаление значения из списка |
...
**Пример использования:**
```ts
var a = variable::get_sign_text(location(0, 0, 0), "FIRST")

// или от переменной:

var b = location(0, 0, 0)
var c = b.get_sign_text("FIRST")
```
